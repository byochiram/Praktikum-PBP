...
<div class="row w-50 mx-auto">
    <div class="col">
        <div class="card mt-4">
            ...
            <div class="card-body">
                <form method="POST" autocomplete="on" id="customerForm">
                    <div class="mb-3">
...
function add_customer_get() {
    ...
    xhr.open('GET', 'add_customer_get.php?name=' + formData.get('name') + '&address=' + formData.get('address') + '&city=' + formData.get('city'), true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && xhr.status == 200) {
            document.getElementById('add_response').innerHTML = xhr.responseText;
        }
    };
    xhr.send(null);
}
...
function add_customer_post() {
    ...
    var formData = new FormData(form);
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'add_customer_post.php', true);
    ...
    xhr.send('name=' + encodeURIComponent(formData.get('name')) + '&address=' + encodeURIComponent(formData.get('address')) + '&city=' + encodeURIComponent(formData.get('city')));
}
</script>
